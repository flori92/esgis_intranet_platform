...
-- À exécuter avec la commande : PGPASSWORD="Apollonf@vi92" psql -h db.zsuszjlgatsylleuopff.supabase.co -p 5432 -U postgres -d postgres -f scripts/create-and-initialize-stages-module.sql

...
const RegisterPage = () => {
   ...
   * @param {string} value - Nom complet à valider
   ...
   * @param {string} value - Confirmation du mot de passe à valider
   * @returns {boolean} true si la confirmation est valide, false sinon
   */
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { error, data } = await signUp(email, password, {
        full_name: fullName,
        role: role, // 'admin' | 'professor' | 'student'
      });
